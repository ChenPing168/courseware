				...
				<div class="row">
					<div class="col-sm-12" >
						...
						<div class="collapse navbar-collapse" id="example-navbar-collapse">
							<ul class="_menu" >
								<li {{if value="'CONTROLLER' eq 'Index'"}}class="_active"{{endif}}><a href="index.php">首页</a></li>
								{{foreach from="$topCate" value="$v"}}
								<li {{if value="$v['cid'] eq Q('get.cid',0,'intval')"}}class="_active"{{endif}}><a href="l{{$v['cid']}}.html">{{$v['cname']}}</a></li>
								{{endforeach}}
							</ul>
						</div>
					</div>
