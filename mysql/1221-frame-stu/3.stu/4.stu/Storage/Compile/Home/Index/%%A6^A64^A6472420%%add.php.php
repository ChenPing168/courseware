<?php /* Smarty version 2.6.26, created on 2015-12-21 11:15:45
         compiled from add.php */ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8" />
...
<form action="" method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="请输入班级" name="cname" required="">
  </div>
