<?php /* Smarty version 2.6.26, created on 2015-12-22 09:40:25
...
<form action="" method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="请输入姓名" name="sname" required="">
  </div>
