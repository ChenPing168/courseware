<?php /* Smarty version 2.6.26, created on 2015-12-22 09:48:09
...
?>
	  		<tr>
	  			...
	  			<td>
	  				<a href="?c=Stu&a=edit&sid=<?php echo $this->_tpl_vars['v']['sid']; ?>
" class="btn btn-primary btn-sm">编辑</a>
	  				<a href="javascript:if(confirm('确定删除吗？')) location.href='index.php?c=Stu&a=del&sid=<?php echo $this->_tpl_vars['v']['sid']; ?>
