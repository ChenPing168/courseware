				...
				<ul>
					...
					<li class="attr-border">
						...
						<ul class="attr-content">
							...
							?>
							<li>
								<a href="<?php echo U('List/index',array('cid'=>$_GET['cid'],'param'=>implode('_',$temp)))?>"  <?php if($param[$k]==0){?>
                class="hover"
               <?php }?> >不限</a>
							</li>
							...
							?>
							<li>
								<a href="<?php echo U('List/index',array('cid'=>$_GET['cid'],'param'=>implode('_',$temp)))?>"  <?php if($param[$k]==$value['gtid']){?>
                class="hover"
               <?php }?>><?php echo $value['gtvalue']?></a>
							</li>
							<?php }?>
						</ul>
					</li>
