...
var game = function(){
	...
	hdThis.hdInit = function(){
		...
		//初始一个字母
		hdThis.hdTypeArr.push(hdThis.hdTypedObj.hdGetLetter());
	}
	//2.绘制(绘制背景，绘制字母)
	hdThis.hdFlashCtx = function(){
		...
		hdThis.hdCtx.fillStyle = 'red';
		hdThis.hdCtx.fillText('正确： ' + hdThis.hdRightNum + '   错误：' + hdThis.hdErrNum,0,20);
	...
	hdThis.gameOver = function(){
		if(hdThis.hdErrNum >= 10){
			...
			//背景音乐停止
			document.getElementById("huanbanxie").pause();
		}
	}
	//底部检测
